...
import { TypeAction, TypeSubject, type TutorModel } from '@/models';
import { TutorCreate, TutorTable } from '.';
import { Button } from '@/components';
import { usePermissionStore, useTutorStore } from '@/hooks';
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-foreground">Tutores</h2>
        {
          hasPermission(TypeAction.create, TypeSubject.tutor) && <Button
