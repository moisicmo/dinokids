                ...
                }
                {
                  ...
                  <>
                    <div className="flex text-sm">
                      ...
                      <span className="font-medium text-gray-900 break-all">{item.teacher.zone}</span>
                    </div>
                    <div className="flex text-sm">
                      <span className="w-20 text-gray-500">Dirección:</span>
                      <span className="font-medium text-gray-900 break-all">{item.teacher.address}</span>
                    </div>
                    <div className="flex text-sm">
                      <span className="w-20 text-gray-500">Título:</span>
                      <span className="font-medium text-gray-900 break-all">{item.teacher.major}</span>
                    </div>
                    <div className="flex text-sm">
                      <span className="w-20 text-gray-500">Estado académico:</span>
                      <span className="font-medium text-gray-900 break-all">{item.teacher.academicStatus}</span>
                    </div>
                    <div className="flex text-sm">
                      <span className="w-20 text-gray-500">Fecha de inicio:</span>
                      <span className="font-medium text-gray-900 break-all">{format(new Date(item.teacher.startJob), 'dd-MMMM-yyyy', { locale: es })}</span>
                    </div>
                  </>
                }
              </div>
