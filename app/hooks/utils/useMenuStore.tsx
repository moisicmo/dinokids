...
import {
  ...
  HandCoins as CashBox,
  History as CashBoxHistory,
  Receipt as DebtIcon,
  School as Specialty,
...
export const useMenu = (): MenuItem[] => {
  ...
  if (hasPermission(TypeAction.manage, TypeSubject.debt)) {
    financeItems.push({
      path: '/admin/debt',
      title: 'Deudas',
  ...
  if (hasPermission(TypeAction.manage, TypeSubject.cashBox)) {
    financeItems.push({
      path: '/admin/cash-movement',
      title: 'Caja',
      icon: <CashBox size={18} />,
    });
    financeItems.push({
      path: '/admin/cash-box',
      title: 'Historial de Caja',
      icon: <CashBoxHistory size={18} />,
    });
  }
